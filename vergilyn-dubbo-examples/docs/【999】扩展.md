...
+ [github, vergilyn, BeanWrapperMainTest.java](https://github.com/vergilyn/spring-framework-examples/blob/master/spring-base-examples/src/test/java/com/vergilyn/examples/beans/wrapper/BeanWrapperMainTest.java)
